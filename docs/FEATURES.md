...
> [INTEGRATIONS.md](INTEGRATIONS.md) to connect it to your AI. Recipes: [USE-CASES.md](USE-CASES.md).
...
- **⚠️ Fidelity:** via MCP the AI passes *what's in its context* — for a very long chat that may
